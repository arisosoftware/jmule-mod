...
public class Utils {
	...
	/**
	 * Always filter following IP's : 0.0.0.0 invalid. 127.0.0.0 - 127.255.255.255
	 * Loopback. 224.0.0.0 - 239.255.255.255 Multicast. 240.0.0.0 - 255.255.255.255
	 * Reserved for Future Use. 255.255.255.255 invalid.
	 * 
	 * @param address
	 * @return
	 */
	...
	public static Int128 XOR(Int128 a, Int128 b) {
		...
		/*
		 * BitSet result = new BitSet(128); for (int i = 0; i < result.size(); i++)
		 * result.set(i, a.getBit(i) ^ b.getBit(i)); return new Int128(result);
		 */
	}

	/**
	 * Retrun bigger rang from bit set. Example : 0101011000 Result is : 7 ^
	 * 
	 * @param bitSet
	 * @return bigger rang
	 */
	 ...
	 * 
	 * @param targetID
	 *            XOR distance from JKad to target
	 * @param contactList
	 * @param exceptList
	 * @return nearest contact or null
	 */
	public static KadContact getNearestContact(Int128 targetID, Collection<KadContact> contactList,
			Set<ClientID> exceptList) {
