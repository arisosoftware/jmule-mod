 ...
 * 
 * @author binary256
 * @version $Revision: 1.17 $ Last changed by $Author: binary255 $ on $Date:
 *          2010/08/22 12:48:02 $
 */
public class Int128 implements Cloneable {
	 ...
	 * 
	 * @param position
	 *            position 0 is higher value, 127 is lower
	 * @param value
	 */
	 ...
	 * 
	 * @param reverse
	 *            true - show how is stored value, false - how is processed
	 * @return
	 */
	 ...
	 * 
	 * @param reverse
	 *            set true if you want to store string and easy load with
	...
	public boolean equals(Object value) {
		...
		// System.out.println( (hashCode() == o.hashCode()) + " :: " + hashCode() + " ::
		// " + o.hashCode + " \n" + toHexString() + "\n"+o.toHexString() + "\n" );
		// System.out.println( bit_set.equals(o.getBitSet()) + " :: " + hashCode() + "
		// :: " + o.hashCode() );*/
