 ...
 * @author javajox
 * @author binary
 * @version $$Revision: 1.9 $$ Last changed by $$Author: javajox $$ on $$Date:
 *          2010/01/10 14:18:48 $$
 */
public interface DownloadManager extends JMuleManager {
	...
	/**
	 * Adds a new download and start it, no exception is thrown if something is
	 * wrong this means if something goes wrong we'll never know what really
	 * happened
	 * 
	 * @param ed2kLink
	 *            as {@link ED2KFileLink}
	 */
	 ...
	 * happened
	 * 
	 * @param edk2LinkAsString
	 *            the ed2k link as String
	 */
	 ...
	 * Adds a new download and start it, no exception is thrown if something is
	 * wrong this means if something goes wrong we'll never know what really
	 * happened, the method returns the download manager, so it's easy to add many
	 * downloads and start them, we can build things like : <code>
	 ...
	 * </code> <remark> This method works in conjunction with
	 * finishAddAndStartSilentDownloads() </remark>
	 * 
	...
	/**
	 * Silently cancel the downloads. <b>Attention !!! This is a very dangerous
	 * method, no restore point is provided</b>
	 */
