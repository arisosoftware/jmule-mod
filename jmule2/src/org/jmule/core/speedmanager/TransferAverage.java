...
/**
 * This class calculates average transfer speed. It trackes the average over a
 * given period with a given refresh time. It is based on a cyclic array of
 * longs to store its values.
 * 
 * @author gregork
 * @author binary
