...
public interface ServerManager extends JMuleManager {
	 ...
	 * 
	 * @param server
	 *            the server that is added to the server list
	 */
	 ...
	 *            the given server
	 * @throws ServerManagerException
	 *             if the server is not present in the list or the server can't be
	 *             reached
	 */
	 ...
	 * 
	 * @param serverListListener
	 *            the given server list listener
	 */
