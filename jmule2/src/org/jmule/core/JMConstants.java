 ...
 * 
 * @author javajox
 * @version $$Revision: 1.13 $$ Last changed by $$Author: javajox $$ on $$Date:
 *          2010/01/13 17:28:37 $$
 */
public class JMConstants {
	...
	public static final String CURRENT_JMULE_VERSION = IS_NIGHTLY_BUILD ? DEV_VERSION
			: (JMULE_VERSION + (IS_BETA ? " Beta" : ""));
	 ...
	 * @return <code>true</code> if the actual version is equal or greater than the
	 *         required version
	 */
