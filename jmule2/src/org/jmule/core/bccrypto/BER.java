...
public class BER {
	...
	public static class BERConstructedOctetString extends DER.DEROctetString {
		...
		public BERConstructedOctetString(DER.DERObject obj) {
			super(obj);
		}

		public BERConstructedOctetString(DER.DEREncodable obj) {
		...
		public void encode(DER.DEROutputStream out) throws IOException {
	...
	public static class BERConstructedSequence extends DER.DERConstructedSequence {
		/*
		 */
		void encode(DER.DEROutputStream out) throws IOException {
			if (out instanceof ASN1OutputStream) {
	...
	public static class BERInputStream extends DER.DERInputStream {
	...
	public static class BERNull extends DER.DERNull {
	...
	public static class BERSequence extends DERSequence {
		 ...
		 */
		public BERSequence(DER.DEREncodable obj) {
			super(obj);
		}
	...
	public static class BERSet extends DERSet {
		/**
	...
	/**
	 * BER TaggedObject - in ASN.1 nottation this is any object proceeded by a [n]
	 * where n is some number - these are assume to follow the construction rules
	 * (as with sequences).
	 */
	public static class BERTaggedObject extends DER.DERTaggedObject {
		/**
		 * @param tagNo
		 ...
		 *            the tagged object.
		 */
		public BERTaggedObject(int tagNo, DER.DEREncodable obj) {
			super(tagNo, obj);
		}
		 ...
		 *            the tagged object.
		 */
		public BERTaggedObject(boolean explicit, int tagNo, DER.DEREncodable obj) {
