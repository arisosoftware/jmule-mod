 ...
 * 
 * @author javajox
 * @version $$Revision: 1.45 $$ Last changed by $$Author: binary255 $$ on
 *          $$Date: 2010/09/04 16:01:25 $$
 */
public interface ConfigurationManager extends JMuleManager {
	...
	//
	// public static final String PEER_ACTIVITY_CHECK_TIME_KEY =
	// "PeerActivityCheckTime";
	// public static final String SOURCES_QUERY_INTERVAL_KEY =
	// "SourcesQueryInterval";
	// public static final String PEER_INACTIVITY_REMOVE_TIME_KEY =
	// "PeerInactivityRemoveTime";
	 ...
	 * 
	 * @param tcp
	 *            the given value of the tcp port
	 */
	 ...
	 * 
	 * @param udp
	 *            the given value of the udp port
	 */
	 ...
	 * 
	 * @param listener
	 *            the given configuration listener
	 */
