...
public class GapList {
	 ...
	 * 
	 * @param byteSize
	 *            The number of bytes in the GapList.
	 */
	...
	/**
	 * Returns the gaps stored in the GapList that are completely inside a a given
	 * range.
	 * 
	 * @param start
	 *            The range start.
	 * @param end
	 *            The range end .
	 * @return The gaps stored in the GapList that are completely inside a a given
	 *         range.
	 */
	...
	/**
	 * Returns a new GapList only with gaps covering the selected range. It chops
	 * the begining and ending gaps if necesary.
	 * 
	 * @param start
	 *            The gap start.
	 * @param end
	 *            The gap end.
	 * 
	 * @return A new GapList only with gaps covering the selected range. It chops
	 *         the begining and ending gaps if necesary.
	 */
