...
public interface SharingManager extends JMuleManager {
	...
	/**
	 * Tells if the file identified by fileHash exists in the shared files hashtable
	 * and also checks if the file exists in the file file system
	 * 
	 * @param fileHash
	 *            the given file hash
	 * @return true if the file exists in shared files hashtable and in the file
	 *         system
	 */
	...
	/**
	 * Loads the completed shared files from shared folders. This is a long time
	 * process that eats a lot of CPU cycles. Can be interrupted with
	 ...
	 * that eats a lot of CPU cycles. Can be interrupted with
	...
	/**
	 * Move the completed file (identified by fileHash) from temp dir to incoming
	 * dir
	 * 
	 * @param fileHash
	...
	/**
	 * Write the all meta-info about files from completed files hash table in
	 * known.met
	 */
