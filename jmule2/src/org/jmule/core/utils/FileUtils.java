...
public class FileUtils {
	...
	public static List<File> extractNewFolders(File[] current_chosen_folders, List<File> chosen_folders,
			List<File> mustAddFolders) {
		...
		for (File f1 : current_chosen_folders) {
			...
			if (must_be_added)
				mustAddFolders.add(f1);
			else
				already_existed_folders.add(f1);
		}
