...
public class JMuleCoreStats {
	...
	private static final String[] _ST_ALL = { ST_NET_SESSION_DOWNLOAD_BYTES, ST_NET_SESSION_UPLOAD_BYTES,
			ST_NET_SESSION_DOWNLOAD_COUNT, ST_NET_SESSION_UPLOAD_COUNT, ST_NET_PEERS_COUNT, ST_NET_PEERS_DOWNLOAD_COUNT,
			ST_NET_PEERS_UPLOAD_COUNT, ST_NET_SERVERS_COUNT, ST_NET_SERVERS_DEAD_COUNT, ST_NET_SERVERS_ALIVE_COUNT,
			ST_DISK_SHARED_FILES_COUNT, ST_DISK_SHARED_FILES_PARTIAL_COUNT, ST_DISK_SHARED_FILES_COMPLETE_COUNT,
			ST_DISK_SHARED_FILES_BYTES, ST_DISK_SHARED_FILES_PARTIAL_BYTES, ST_DISK_SHARED_FILES_COMPLETE_BYTES,
			SEARCHES_COUNT };
