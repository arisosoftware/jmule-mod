...
public class UDPPacketFactory {
	...
	/**
	 * Server status request packet : request more server information : hard/soft
	 * limits, users, files.
	 * 
	 * @param clientTime
	 * 
	 ...
	 *            <td>4</td>
	 *            <td>NA</td>
	 *            <td>A unsigned integer challenge sent to the server, used for
	 *            reply verification (the corresponding variable is called 'time' on
	 *            the client)</td>
	 *            </tr>
	 *            </tbody>
	 *            </table>
	 ...
	 *         <td>NA</td>
	 *         <td>NA</td>
	 *         <td>A list of file IDs (hashes) (each 16 byte length), The IDs are
	 *         ordered one after the other without a preceding count</td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
	 *         </table>
	 ...
	 *         <td>1</td>
	 *         <td>0x98 or 0x92</td>
	 *         <td>The value of the OP_GLOBSEARCHREQ or the OP_GLOBSEARCHREQ2
	 *         opcodes respectively</td>
	 *         </tr>
	 *         <tr>
	 *         <td>Search request parameters</td>
	 *         <td>Varies</td>
	 *         <td>NA</td>
	 *         <td>Same as the search request message parameters in the Client to
	 *         Server TCP communication</td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
	 *         </table>
	 ...
	 *         <td>2</td>
	 *         <td>NA</td>
	 *         <td>Optional. Unsigned integer, The current number of sources of the
	 *         requested file</td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
