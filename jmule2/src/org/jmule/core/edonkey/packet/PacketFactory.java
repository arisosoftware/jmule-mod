 ...
 * 
 * @author binary256
 * @version $$Revision: 1.26 $$ Last changed by $$Author: binary255 $$ on
 *          $$Date: 2010/07/31 16:00:42 $$
 */
public class PacketFactory {
	 ...
	 * <td>4</td>
	 * <td>-</td>
	 * <td>The size of the message in bytes not including the header and size
	 * fileds</td>
	 * </tr>
	 * <tr>
	 * <td>Type</td>
	 ...
	 * <td>varies</td>
	 * <td>NA</td>
	 * <td>The user's nickname. The tag is a string tag and the tag name is an
	 * integer of value 0x1</td>
	 * </tr>
	 * <tr>
	 * <td>Version Tag</td>
	 * <td>8</td>
	 * <td>0x3C</td>
	 * <td>The eDonkey version supported by the client. The tag is an integer tag
	 * and the tag name is an integer of value 0x11</td>
	 * </tr>
	 * <tr>
	 * <td>Port Tag</td>
	 * <td>8</td>
	 * <td>4662</td>
	 * <td>The TCP port used by the client. The tag is an integer tag and the tag
	 * name is an integer of value 0x0F</td>
	 * </tr>
	 * <tr>
	 * <td>Flags Tag</td>
	 * <td>8</td>
	 * <td>0x01</td>
	 * <td>The tag is an integer tag and the tag name is an integer of value
	 * 0x20</td>
	 * </tr>
	 * </tbody>
	 * </table>
	 * </table>
	 */
	public static Packet getServerLoginPacket(UserHash userHash, int clientPort, String userNickName)
			throws JMException {
	 ...
	 * <td>varies</td>
	 * <td>NA</td>
	 * <td>Optional. A string constraint. The string values are one of ("Audio",
	 * "Video", "Pro" or "Image". The type field is 3 bytes: 0x1 0x0 0x3</td>
	 * </tr>
	 * <tr>
	 * <td>Min Size Constraint</td>
	 * <td>varies</td>
	 * <td>NA</td>
	 * <td>Optional. An integer constraint. The file size is provided in mega bytes.
	 * The type field is 4 bytes : 0x1 0x1 0x0 0x2</td>
	 * </tr>
	 * <tr>
	 ...
	 * <td>NA</td>
	 * <td>Optional. An integer constraint. The file size is provided in mega bytes.
	 * The type field is 4 bytes : 0x2 0x1 0x0 0x2</td>
	 * </tr>
	 * <tr>
	 * <td>Availability Constraint</td>
	 * <td>varies</td>
	 * <td>NA</td>
	 * <td>Optional. An integer constraint. Sets a lower limit on the number of
	 * clien that poses the searched file. The type field is 4 bytes: 0x1 0x1 0x0
	 * 0x15</td>
	 * </tr>
	 * <tr>
	 ...
	 * <td>varies</td>
	 * <td>NA</td>
	 * <td>Optional. A string constraint. The type field is 3 bytes: 0x1 0x0
	 * 0x3</td>
	 * </tr>
	 * </tbody>
	 * </table>
	 ...
	 *            <td>4</td>
	 *            <td>-</td>
	 *            <td>The size of the message in bytes not including the header and
	 *            size fields</td>
	 *            </tr>
	 *            <tr>
	 *            <td>Type</td>
	 ...
	 *         <td>1</td>
	 *         <td>16</td>
	 *         <td>The size of the user hash ï¬�eld</td>
	 *         </tr>
	 *         <tr>
	 *         <td>User Hash</td>
	 *         <td>16</td>
	 ...
	 *         <td>2</td>
	 *         <td>4662</td>
	 *         <td>The TCP port used by the client, conï¬�gurable</td>
	 *         </tr>
	 *         <tr>
	 *         <td>Tag Count</td>
	 *         <td>4</td>
	 ...
	 *         <td>varies</td>
	 *         <td>NA</td>
	 *         <td>A list of tags specifying remote clientâ€™s properties</td>
	 *         </tr>
	 *         <tr>
	 *         <td>Server IP</td>
	 *         <td>4</td>
	 *         <td>NA</td>
	 *         <td>The IP of the server to which the client is connected</td>
	 *         </tr>
	 *         <tr>
	 ...
	 *         </table>
	 */
	public static Packet getPeerHelloPacket(UserHash userHash, ClientID clientID, int myPort, byte[] serverIP,
			int serverPort, String userName, Map<PeerFeatures, Integer> clientFeatures) throws JMException {
	 ...
	 * </table>
	 */
	public static Packet getPeerHelloAnswerPacket(UserHash userHash, ClientID clientID, int myPort, String userName,
			byte[] serverIP, int serverPort, Map<PeerFeatures, Integer> clientFeatures) throws JMException {
	 ...
	 * <td>1</td>
	 * <td>0x58</td>
	 * <td>The value of the OP FILEREQUEST opcode</td>
	 * </tr>
	 * <tr>
	 * <td>File ID</td>
	 * <td>16</td>
	 ...
	 * <td>3</td>
	 * <td>NA</td>
	 * <td>Optional, sent if the extended request version indicated in the eMule
	 * info message is greater than zero. The file significance is explained in this
	 * section</td>
	 * </tr>
	 * <tr>
	 * <td>Source count</td>
	 ...
	 * <td>NA</td>
	 * <td>Optional, sent if the extended request version indicated in the eMule
	 * info message is greater than one. Indicated the current number of sources for
	 * this file</td>
	 * </tr>
	 * </tbody>
	 * </table>
	...
	public static Packet getFileNameRequestPacket(FileHash fileHash, GapList fileGapList, long fileSize,
			int sourceCount) {
	 ...
	 *         <td>1</td>
	 *         <td>0x54</td>
	 *         <td>The value of the OP_ STARTUPLOADREQ opcode</td>
	 *         </tr>
	 *         <tr>
	 *         <td>File ID</td>
	 *         <td>16</td>
	 ...
	 * 
	 * @param fileHash
	 *            hash of download file
	 * @param partsData
	 *            position of parts max 3, format <begin> <begin> <begin> <end>
	 *            <end> <end>
	 * @return
	 *         <table cellspacing="0" border="1" cellpadding="0">
	 *         <thead>
	 ...
	 *         <td>16</td>
	 *         <td>NA</td>
	 *         <td>A unique file ID calculated by hashing the file's data hash</td>
	 *         </tr>
	 *         <tr>
	 *         <td>Part 1 Start offset</td>
	 *         <td>4</td>
	 *         <td>NA</td>
	 ...
	 *         </table>
	 */
	public static Packet getPeerRequestFileParts(FileHash fileHash, FileChunkRequest... partsData) {
	 ...
	 *         <td>1</td>
	 *         <td>0x56</td>
	 *         <td>The value of the OP_ CANCELTRANSFER opcode
	 * 
	 *         </td>
	 *         </tr>
	 *         </tbody>
	 ...
	 *         <td>1</td>
	 *         <td>0x49</td>
	 *         <td>The value of the OP END OF DOWNLOAD opcode</td>
	 *         </tr>
	 *         <tr>
	 *         <td>File ID</td>
	 *         <td>16</td>
	 ...
	 *         <td>2</td>
	 *         <td>NA</td>
	 *         <td>Optional, sent if the extended request version indicated in the
	 *         eMule info message is greater than zero. The file significance is
	 *         explained in this section</td>
	 *         </tr>
	 *         <tr>
	 *         <td>Filename</td>
	 *         <td>Varies</td>
	 *         <td>NA</td>
	 *         <td>Optional, sent if the extended request version indicated in the
	 *         eMule info message is greater than one. Indicated the current number
	 *         of sources for this file</td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
	 */
	public static Packet getFileRequestAnswerPacket(FileHash fileHash, String fileName) {
	 ...
	 *         <td>&nbsp;</td>
	 *         <td>NA</td>
	 *         <td>bit array with parts status : 1 - completed part ; 0 -
	 *         uncompleted part</td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
	 ...
	 *         <td>Varies</td>
	 *         <td>NA</td>
	 *         <td>A hash for each file part - the size of each hash is 16 bytes
	 *         </td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
	...
	public static Packet getFileHashReplyPacket(PartHashSet fileHashSet) {
		Packet packet = new Packet(16 + 2 + 16 * fileHashSet.size(), PROTO_EDONKEY_TCP);
	 ...
	 *         <td>1</td>
	 *         <td>0x55</td>
	 *         <td>The value of the OP_ACCEPTUPLOADREQ opcode</td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
	 *         </table>
	 ...
	 *         <td>16</td>
	 *         <td>NA</td>
	 *         <td>A unique file ID calculated by hashing the fileâ€™s data</td>
	 *         </tr>
	 *         <tr>
	 *         <td>Start Pos</td>
	 *         <td>4</td>
	 ...
	 *         <td>&nbsp;</td>
	 *         <td>&nbsp;</td>
	 *         <td>The actual downloaded data. This data may be compressed.</td>
	 *         </tr>
	 *         </tbody>
	 *         </table>
	 *         </table>
	...
	public static Packet getFilePartSendingPacket(FileHash fileHash, FileChunk fileChunk) {
		Packet packet = new Packet(16 + 4 + 4 + fileChunk.getChunkData().capacity(), PROTO_EDONKEY_TCP);
	 ...
	 *         <td>1</td>
	 *         <td>0x48</td>
	 *         <td>The value of the OP FILEREQANSNOFIL opcode</td>
	 *         </tr>
	 *         <tr>
	 *         <td>File ID</td>
	 *         <td>16</td>
	...
	public static Packet getEMulePeerHelloPacket() throws JMException {
		...
		Packet packet = new Packet(1 + 4 + 1 + 1 + 1 + 4 + tag_list.getByteSize(), PROTO_EMULE_EXTENDED_TCP);
	 ...
	 * <td>4</td>
	 * <td>-</td>
	 * <td>The size of the message in bytes not including the header and size fields
	 * </td>
	 * </tr>
	 * <tr>
	 * <td>Type</td>
	 * <td>1</td>
	 * <td>0x02</td>
	 * <td>The value of the OP EMULEINFOANSWER opcode</td>
	 * </tr>
	 * <tr>
	 * <td>eMule Info fields</td>
	 * <td>&nbsp;</td>
	 * <td>&nbsp;</td>
	 * <td>This message has the same fields as an eMule info message.</td>
	 * </tr>
	 * </tbody>
	 * </table>
	 */
	 ...
	 *            <td>1</td>
	 *            <td>0x60</td>
	 *            <td>The value of the OP_QUEUERANKING opcode</td>
	 *            </tr>
	 *            <tr>
	...
	/**
	 * PEX request Create sources request packet
	 * 
	 * @param fileHash
	 *            hash of file which sources are requested.
	 *            <table cellspacing="0" border="1" cellpadding="0">
	 *            <thead>
	 *            <tr>
	 *            <th>Name</th>
	 ...
	 *            <td>1</td>
	 *            <td>0x81</td>
	 *            <td>The value of the OP_ REQUESTSOURCES opcode</td>
	 *            </tr>
	 *            <tr>
	 *            <td>File ID</td>
	 *            <td>16</td>
