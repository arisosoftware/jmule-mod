...
public class ED2KConstants {
	...
	public final static int ServerSoftwareVersion = ((ServerClientSoftware << 24) | (ServerSoftwareVersionMajor << 17)
			| (ServerSoftwareVersionMinor << 10) | (ServerSoftwareVersionUpdate << 7));
	...
	public static enum ServerFeatures {
		// TCP + UDP flags
		Compression, NewTags, Unicode, LargeFiles,
		// Only TCP flags
		RelatedSearch, TypeTagInteger, TCPObfusication,
		// Only UDP Flags
		GetSources, GetFiles, GetSources2, UDPObfusication
	}

	public static enum PeerFeatures {
		// Misc options 1
		SupportsAICH, SupportsUnicode, UDPVersion, DataCompressionVersion, SupportsSecureIdentification, SourceExchange1Version, ExtendedRequestsVersion, AcceptCommentVersion, PeerCache, NoViewSharedFiles, MultiPacket, SupportsPreview,

		// Misc options 2
		SupportsFileIdent, DirectUDPCallback, SupportsCaptcha, SupportsSourceEx2, RequiresCryptLayer, RequestsCryptLayer, SupportsCryptLayer, ModBit, ExtMultiPacket, SupportsLargeFiles, KadVersion,
