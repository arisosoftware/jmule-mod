...
/**
 * ED2K server link ed2k://|server|IP|PORT|/
 * 
 * @author binary
...
public class ED2KServerLink extends ED2KLink {
	...
	public ED2KServerLink(String link) {
		...
		s = Pattern.compile(
				"ed2k:\\/\\/\\|server\\|([0-9]{1,3}+.[0-9]{1,3}+.[0-9]{1,3}+.[0-9]{1,3}+)\\|([0-65535]*)\\|\\/");
	...
	public boolean equals(Object object) {
		if (object == null)
			return false;
		if (!(object instanceof ED2KServerLink))
			return false;
	...
	public static void main(String... args) {
		...
		/*
		 * String text =
		 * "dwhkgshked2k://|server|207.44.222.51|4242|/sdasded2k://|server|207.44.222.51|4242|/ed2k://|server|207.44.222.51|4242|/";
		 * List<ED2KServerLink> list = ED2KServerLink.extractLinks(text);
		 * 
		 * for(ED2KServerLink l : list) { System.out.println(l+""); }
		 */
