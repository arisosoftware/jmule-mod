...
public class TimeFormatter {
	...
	/**
	 * Format time into two time sections, the first chunk trimmed, the second with
	 * always with 2 digits. Sections are *d, **h, **m, **s. Section will be skipped
	 * if 0.
	 * 
	 * @param time
	 *            time in ms
	...
	public static String format(long time) {
		...
		int[] vals = { (int) time % 60, (int) (time / 60) % 60, (int) (time / 3600) % 24, (int) (time / 86400) };
