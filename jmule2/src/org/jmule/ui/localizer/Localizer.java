 ...
 * @author javajox
 * @author binary256
 * @version $$Revision: 1.4 $$ Last changed by $$Author: binary256_ $$ on
 *          $$Date: 2008/10/16 18:20:55 $$
 */
public class Localizer {
	...
	public static void initialize() {
		InputStream input_stream = (Localizer.class.getClassLoader()
				.getResourceAsStream("org/jmule/ui/resources/internat/Language_en_US.properties"));
		try {
	...
	/**
	 * Expands a message text and replaces occurrences of %1 with first param, %2
	 * with second...
	 * 
	 * @param key
	 * @param params
