...
public class NavigationBar extends JPanel implements JMuleUIComponent {
	...
	public void initUIComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
				...
				layout.createSequentialGroup().addContainerGap(110, Short.MAX_VALUE).add(backButton)
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(nextButton).add(30, 30, 30)
						.add(cancelButton).addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED).add(finishButton)
						.add(20, 20, 20)));
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(layout.createSequentialGroup().addContainerGap()
						.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(finishButton)
								.add(cancelButton).add(nextButton).add(backButton))
