...
public class WelcomeMessage extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		String welcome_text = "<html><center>&nbsp;&nbsp;&nbsp;Welcome to the " + JMConstants.JMULE_NAME
				+ "  Installation Wizard</center></html>";
		welcome_label.setText(welcome_text);
		add(welcome_label);

		what_wizard_is_good_for_label.setFont(new java.awt.Font("Dialog", 0, 14));
		String what_wizard = "<html><center>&nbsp;&nbsp;&nbsp;This wizard will guide you through the installation process of "
				+ JMConstants.JMULE_NAME + " ver. " + JMConstants.JMULE_VERSION + "</center></html>";
		what_wizard_is_good_for_label.setText(what_wizard);
		add(what_wizard_is_good_for_label);

		if (JMConstants.IS_NIGHTLY_BUILD) {
			String str = "<html><center>&nbsp;&nbsp;&nbsp;Attention ! this is unstable <b>" + JMConstants.DEV_VERSION
					+ " CVS build of " + JMConstants.JMULE_NAME
					+ "</b></center><br><center>Any comments or suggestions are welcome</center><br><center>Our forums <font color=blue>"
					+ JMConstants.JMULE_FORUMS + "</font></center></html>";
