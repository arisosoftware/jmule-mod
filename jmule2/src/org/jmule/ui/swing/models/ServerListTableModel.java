...
public class ServerListTableModel extends JMTableModel {
	...
	private final static String[] column_names = { "Name", "CC", "Flag", "IP", "Description", "Ping", "Users",
			"Max users", "Files", "Soft limit", "Hard limit", "Version", "Static", "Down" };
	...
	public Class getColumnClass(int col) {
		...
		/*
		 * switch (col) { case 0 : return Server.class; case 1 : return String.class;
		 * case 2 : return String.class; case 3 : return String.class; case 4 : return
		 * String.class; case 5 : return Integer.class; case 6 : return Integer.class;
		 * case 7 : return Integer.class; case 8 : return Integer.class; case 9 : return
		 * Integer.class; case 10 : return Integer.class; case 11 : return String.class;
		 * case 12 : return String.class; default : return Object.class; }
		 */
		return Server.class;
	}
	...
	public Object getValueAt(int row, int col) {
		...
		for (Server server : _server_manager.getServers()) {
			...
			if (i == row) {
				 ...
				 * switch( col ) {
				 * 
				 * case 0 : return server; case 1 : return
				 * !CountryLocator.getInstance().isServiceDown() ?
				 * CountryLocator.getInstance().getCountryCode(server.getAddress()) : "Unknown";
				 * case 2 : return server.getAddress(); case 3 : return server.getAddress() +
				 * ":" + server.getPort(); case 4 : return server; case 5 : return
				 * server.getPing(); case 6 : return server.getNumUsers(); case 7 : return
				 * server.getMaxUsers(); case 8 : return server.getNumFiles(); case 9 : return
				 * server.getSoftLimit(); case 10 : return server.getHardLimit(); case 11 :
				 * return server.getVersion(); case 12 : return ( server.isStatic() ? "Yes" :
				 * "No"); }
				 */
