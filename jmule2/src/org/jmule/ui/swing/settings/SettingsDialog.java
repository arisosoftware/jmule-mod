...
public class SettingsDialog extends JDialog implements IDialog {
	...
	private void init() {
		...
		enable_udp_checkbox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				if (enable_udp_checkbox.isSelected())
					udp_text_field.setEnabled(true);
				else
					udp_text_field.setEnabled(false);
			}
		});
		enabled_download_limit_checkbox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				if (enabled_download_limit_checkbox.isSelected())
					download_limit_text_field.setEnabled(true);
				else
		...
		enabled_upload_limit_checkbox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				if (enabled_upload_limit_checkbox.isSelected())
					upload_limit_text_field.setEnabled(true);
				else
		...
		try {
			{
				...
				getContentPane().add(nickname_label, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
				getContentPane().add(nickname_text_field, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
				getContentPane().add(prompt_on_exit_checkbox, new GridBagConstraints(0, 2, 3, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 25, 0, 0), 0, 0));
				getContentPane().add(update_servelist_checkbox, new GridBagConstraints(0, 3, 3, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 25, 0, 0), 0, 0));
				getContentPane().add(check_for_updates_checkbox, new GridBagConstraints(0, 4, 3, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 25, 0, 0), 0, 0));
				getContentPane().add(nightly_build_warning_checkbox, new GridBagConstraints(0, 5, 3, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 25, 0, 0), 0, 0));
				{
					...
					getContentPane().add(ports_panel, new GridBagConstraints(0, 6, 4, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
					ports_panel.setLayout(ports_panelLayout);
					ports_panel.setBorder(BorderFactory.createTitledBorder("Ports"));
					ports_panel.add(tcp_label, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
							GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					ports_panel.add(udp_label, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
							GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					ports_panel.add(tcp_text_field, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 15, 0, 15), 0, 0));
					ports_panel.add(udp_text_field, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 15, 0, 15), 0, 0));
					ports_panel.add(enable_udp_checkbox, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
				...
				}
				{
					...
					getContentPane().add(limits_panel, new GridBagConstraints(0, 7, 4, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
					limits_panel.setLayout(limits_panelLayout);
					limits_panel.setBorder(BorderFactory.createTitledBorder("Limits"));
					limits_panel.add(download_limit_label, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					limits_panel.add(upload_limit_label, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					limits_panel.add(download_limit_text_field, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 15, 0, 15), 0, 0));
					limits_panel.add(upload_limit_text_field, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 15, 0, 15), 0, 0));
					limits_panel.add(download_kb_s_label, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
					limits_panel.add(upload_kb_s_label, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
					limits_panel.add(enabled_download_limit_checkbox, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
					limits_panel.add(enabled_upload_limit_checkbox, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
				}
				{
					...
					getContentPane().add(capacities_panel, new GridBagConstraints(0, 8, 4, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
					capacities_panel.setLayout(capacities_panelLayout);
					capacities_panel.setBorder(BorderFactory.createTitledBorder("Capacities"));
					capacities_panel.add(download_capacity_label, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					capacities_panel.add(upload_capacity_label, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
					capacities_panel.add(download_capacity_text_field, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
					capacities_panel.add(upload_capacity_text_field, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
					capacities_panel.add(capacity_k_bit_s_radiobox, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
					capacities_panel.add(capacity_k_byte_s_radiobox, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0,
							GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
				...
				}
				{
					...
					getContentPane().add(operations_panel, new GridBagConstraints(0, 9, 4, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
					...
					operations_panel.add(ok_button, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 10), 0, 0));
					operations_panel.add(cancel_button, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 10), 0, 0));
					operations_panel.add(apply_button, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 10), 0, 0));
				}
			}
		} catch (Exception e) {
	...
	private void setInitData() {
		try {
			...
			// this.setNightlyBuildWarningEnabled(_ui_pref.
			// setNightlyBuildWarningEnabled(SwingConstants.SWING_ROOT)));
	...
	private void saveSettings() {
		try {
			// core settings
			if (_config.getTCP() != this.getTCP())
				_config.setTCP(this.getTCP());
			if (_config.getUDP() != this.getUDP())
				_config.setUDP(this.getUDP());
			if (_config.isUDPEnabled() != this.isUDPEnabled())
				_config.setUDPEnabled(this.isUDPEnabled());
			if (!_config.getNickName().equals(this.getNickname()))
				_config.setNickName(this.getNickname());
			if (_config.getDownloadBandwidth() != this.getDownloadCapacity())
				_config.setDownloadBandwidth(this.getDownloadCapacity());
			if (_config.getUploadBandwidth() != this.getUploadCapacity())
				_config.setUploadBandwidth(getUploadCapacity());
			if (this.isDownloadLimitEnabled())
				_config.setDownloadLimit(getDownloadLimit());
			else
				_config.setDownloadLimit(0);
			if (this.isUploadLimitEnabled())
				_config.setUploadLimit(getUploadLimit());
			else
				_config.setUploadLimit(0);
