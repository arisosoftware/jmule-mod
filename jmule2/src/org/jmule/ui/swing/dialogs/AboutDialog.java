...
public class AboutDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		top_panelLayout.setHorizontalGroup(top_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(top_panelLayout.createSequentialGroup().addContainerGap()
						.add(top_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
								.add(jmule_name_label, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.add(jmule_version_label, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 217,
										Short.MAX_VALUE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 201, Short.MAX_VALUE).add(jmule_icon)
						.addContainerGap()));
		top_panelLayout.setVerticalGroup(top_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(top_panelLayout.createSequentialGroup().addContainerGap().add(top_panelLayout
						.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(top_panelLayout.createSequentialGroup().add(jmule_name_label)
								.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(jmule_version_label))
						.add(jmule_icon))
						.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));

		getContentPane().add(top_panel, java.awt.BorderLayout.PAGE_START);

		internet_panel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Internet",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Dialog", 0, 14), new java.awt.Color(0, 51, 255))); // NOI18N
		...
		/*
		 * org.jdesktop.layout.GroupLayout general_panelLayout = new
		 * org.jdesktop.layout.GroupLayout(general_panel);
		 * general_panel.setLayout(general_panelLayout);
		 * general_panelLayout.setHorizontalGroup(
		 * general_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.
		 * LEADING) .add(internet_panel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
		 * 487, Short.MAX_VALUE) .add(org.jdesktop.layout.GroupLayout.TRAILING,
		 * general_panelLayout.createSequentialGroup() .addContainerGap(61,
		 * Short.MAX_VALUE)
		 * .add(general_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.
		 * LEADING) .add(jmule_license_label) .add(jmule_shot_desc_label)) .add(60, 60,
		 * 60)) ); general_panelLayout.setVerticalGroup(
		 * general_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.
		 * LEADING) .add(org.jdesktop.layout.GroupLayout.TRAILING,
		 * general_panelLayout.createSequentialGroup() .addContainerGap(89,
		 * Short.MAX_VALUE) .add(jmule_shot_desc_label)
		 * .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
		 * .add(jmule_license_label) .add(79, 79, 79) .add(internet_panel,
		...
		text_pane.setText(
				"JMule - Java multi-platform file sharing client for eDonkey 2000 networks, licensed unde the GNU General Public License. The client is completely free and allows you to share files with anybody in the world.\n");
		...
		layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(layout
				...
				.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(layout.createSequentialGroup().addContainerGap().add(scroll_pane,
								org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE))
						.add(layout.createSequentialGroup().addContainerGap().add(jmule_version))
						.add(layout.createSequentialGroup().addContainerGap()
								.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
										.add(layout.createSequentialGroup().add(forums_label).add(18, 18, 18).add(
												forum_jmule_org_label, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												252, Short.MAX_VALUE))
										.add(layout.createSequentialGroup()
												.add(web_site_label, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 71,
														org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
												.add(jmule_org_label, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
														181, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
						.add(layout.createSequentialGroup().addContainerGap().add(copyright_team,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 253,
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
				.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(layout
				.createSequentialGroup().add(30, 30, 30).add(jmule_version)
				.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(copyright_team).add(26, 26, 26)
				.add(scroll_pane, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
						org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
				.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(web_site_label)
						.add(jmule_org_label))
				.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
				.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(forums_label)
		...
		if (JMConstants.IS_NIGHTLY_BUILD)
			tabbed_pane.addTab("Nightly build", new NightlyBuildPanel());
				...
				.setHorizontalGroup(
						bottom_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(org.jdesktop.layout.GroupLayout.TRAILING,
										bottom_panelLayout.createSequentialGroup().addContainerGap(369, Short.MAX_VALUE)
												.add(close_button, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 111,
														org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
												.addContainerGap()));
		bottom_panelLayout
				.setVerticalGroup(bottom_panelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(bottom_panelLayout.createSequentialGroup().addContainerGap().add(close_button)
								.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
