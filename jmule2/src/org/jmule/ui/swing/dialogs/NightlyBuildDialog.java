...
public class NightlyBuildDialog extends JDialog {
	...
	public NightlyBuildDialog(JFrame parent) {
		...
		bottom_panel.add(show_option_checkbox, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		bottom_panel.add(ok_button, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
