...
public class StatisticsTabs extends AbstractTab {
	...
	private void init() {
		...
		stats_fields.put(JMuleCoreStats.ST_DISK_SHARED_FILES_COMPLETE_BYTES,
	...
	private void updateData() {
		...
		java_non_heap_momory_panel.initial_non_heap_memory_value
				.setText(FileFormatter.formatFileSize(nonheap_memory.getInit()));
		java_non_heap_momory_panel.used_non_heap_momory_value
				.setText(FileFormatter.formatFileSize(nonheap_memory.getUsed()));
		java_non_heap_momory_panel.maximum_non_heap_memory_value
				.setText(FileFormatter.formatFileSize(nonheap_memory.getMax()));
