...
public class ServerListTab extends AbstractTab {
	...
	private JSplitPane splitPane; // splits up the visible area into 2 horizontal parts: top, where the server
									// list is located
									// and bottom (server messages and infoes)
	private JSplitPane splitPane2; // bottom visible area is splitted up into 2 vertical parts: left, server
									// messages, right infoes
	...
	private void initComponents() {
		 ...
		 * border, "Unknown", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
		 * javax.swing.border.TitledBorder.DEFAULT_POSITION, titledBorderTextFont,
		 * titledBorderTextColor);
		 */

		// Set up the title border for serverListScrollPane

		serverListScrollPaneBorder = javax.swing.BorderFactory.createTitledBorder(border, "Servers",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				titledBorderTextFont, titledBorderTextColor);
		// TitledBorder serverListScrollPaneBorder =
		// javax.swing.BorderFactory.createTitledBorder("Servers");
		 ...
		 * javax.swing.BorderFactory.createTitledBorder( border, "My info",
		 * javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
		 * javax.swing.border.TitledBorder.DEFAULT_POSITION, titledBorderTextFont,
		 * titledBorderTextColor); myInfoScrollPane.setBorder(myInfoScrollPaneBorder);
		 */
		...
		TitledBorder serverMessagesScrollPaneBorder = javax.swing.BorderFactory.createTitledBorder(border,
				"Server messages", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION, titledBorderTextFont, titledBorderTextColor);
