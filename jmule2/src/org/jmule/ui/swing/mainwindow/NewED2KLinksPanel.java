...
public class NewED2KLinksPanel extends JDialog implements IDialog {
	...
	public class OpPanel extends JPanel {
		...
		private void init() {
			...
			this.setLayout(thisLayout);
			{
				...
				this.add(clearButton, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 5), 0, 0));
				clearButton.setName("clear_button");
			}
			{
				okButton = new JButton();
				this.add(okButton, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 5), 0, 0));
				okButton.setName("ok_button");
			}
			{
				cancelButton = new JButton();
				this.add(cancelButton, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.HORIZONTAL, new Insets(0, 5, 0, 5), 0, 0));
	...
	private void init() {
		...
		central_panel.add(paste_ed2k_links_button, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
			...
			public void actionPerformed(ActionEvent event) {
				try {
					...
					case SERVER:
						...
						break;
					case FILE:
						List<ED2KFileLink> file_links = ED2KFileLink.extractLinks(clipboard_contents.toString());
						ed2k_links = new LinkedList<ED2KLink>();
