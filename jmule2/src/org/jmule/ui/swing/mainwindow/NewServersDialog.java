...
public class NewServersDialog extends NewED2KDialog {
	...
	private void init() {
		...
		central_panel.add(add_server_button, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHEAST,
				GridBagConstraints.HORIZONTAL, new Insets(0, 20, 0, 0), 0, 0));
		central_panel.add(paste_ed2k_links, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTH,
				GridBagConstraints.HORIZONTAL, new Insets(0, 20, 0, 20), 0, 0));
		central_panel.add(learn_about_ed2k_links_label, new GridBagConstraints(0, 2, 3, 1, 0.0, 0.0,
				GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 20, 0, 0), 0, 0));
	...
	private void serversPanel() {
		...
		central_panel.add(add_server_button, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 20, 0, 20), 0, 0));
		central_panel.add(paste_ed2k_links, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
