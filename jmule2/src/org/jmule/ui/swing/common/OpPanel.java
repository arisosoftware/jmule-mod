...
public class OpPanel extends JPanel {
	...
	private void init() {
		 ...
		 * --------------------------------------------
		 */
		if ((button_type_array.length == 1) && (button_type_array[0] == button_type.CLOSE)) {
			...
			this.setLayout(thisLayout);
			{
				...
				this.add(close_button, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
						GridBagConstraints.HORIZONTAL, new Insets(15, 0, 0, 5), 0, 0));
		 ...
		 * --------------------------------------------
		 */
		if ((button_type_array.length == 3) && (button_type_array[0] == button_type.OK)
				&& (button_type_array[1] == button_type.APPLY) && (button_type_array[2] == button_type.CANCEL)) {
			...
			this.add(ok_button, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 10), 0, 0));
			this.add(apply_button, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 10), 0, 0));
			this.add(cancel_button, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 10), 0, 0));
		}
