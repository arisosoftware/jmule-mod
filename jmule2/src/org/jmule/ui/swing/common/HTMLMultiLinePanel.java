...
public class HTMLMultiLinePanel extends JEditorPane {
	...
	public HTMLMultiLinePanel(String text) {
		...
		setFontAndColor(UIManager.getFont("Label.font"), UIManager.getColor("Label.foreground"));
		setBackground(UIManager.getColor("Label.background"));
	}

	public HTMLMultiLinePanel(String text, Font labelFont, Color labelColor, Color labelBgColor) {
		this.text = text;
	...
	/**
	 * Sets the default font and default color. These are set by adding a rule for
	 * the body that specifies the font and color. This allows the html to override
	 * these should it wish to have a custom font or color.
	 */
