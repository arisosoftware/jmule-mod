...
public abstract class JMSAction extends AbstractAction {
	/**
	 * This constant should be used as a storage-retreival key when setting or
	 * getting the <I>ToolTipText</I>.
	 */
	public static final String TOOL_TIP_TEXT = "ToolTipText";

	/**
	 * This constant should be used as a storage-retreival key for medium icons used
	 * for menus (24 x 24)
	 */
	public static final String MEDIUM_ICON = "MediumIcon";

	/**
	 * This constant should be used as a storage-retreival key for large icons (32 x
	 * 32)
	 */
	...
	/**
	 * Defines an Action object with the specified description string <I>name</I>
	 * and a default icon.
	 *
	...
	/**
	 * Defines an Action object with the specified description string <I>name</I>,
	 * the specified <I>icon</I> and the specified <I>toolTipText</I>.
	 *
	 * @see javax.swing.Action#NAME
	 * @see javax.swing.Action#SMALL_ICON
	 */
	...
	/**
	 * Defines an Action object with the specified description string <I>name</I>,
	 * the specified <I>icon</I>, the specified <I>toolTipText</I> and the specified
	 * <I>menuShortCut<I>.
	 *
	 * @see javax.swing.Action#NAME
	 * @see javax.swing.Action#SMALL_ICON
	 ...
	 * @see javax.swing.Action#SMALL_ICON
	 */
	public JMSAction(String name, Icon smallIcon, String toolTipText, Integer mnemonic, KeyStroke keyStroke) {
	 ...
	 * @see javax.swing.Action#SMALL_ICON
	 */
	public JMSAction(String name, Icon smallIcon, Icon largeIcon, String toolTipText, Integer mnemonic) {
		this(name, smallIcon, largeIcon, toolTipText, mnemonic, null);
	}

	/**
	 * Defines an Action object with the specified description string <I>name</I>,
	 * the specified <I>icon</I>, the specified <I>toolTipText</I>, the specified
	 * <I>menuShortCut<I> and the specified <I>accelerator<I>.
	 *
	 * @see javax.swing.Action#NAME
	 * @see javax.swing.Action#SMALL_ICON
	 */
	public JMSAction(String name, Icon smallIcon, Icon mediumIcon, String toolTipText, Integer mnemonic,
	...
	/**
	 * This could be used by the action to indicate it likes to be displayed as a
	 * toggle action.
	 * 
	...
	/**
	 * This method is called to refresh the button state. It can check here if it
