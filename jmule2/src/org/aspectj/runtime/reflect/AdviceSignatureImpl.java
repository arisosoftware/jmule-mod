...
class AdviceSignatureImpl extends CodeSignatureImpl implements AdviceSignature {
	...
	AdviceSignatureImpl(int modifiers, String name, Class declaringType, Class[] parameterTypes,
	...
	/*
	 * name is consistent with reflection API before and after always return
	 * Void.TYPE (some around also return Void.Type)
	 */
