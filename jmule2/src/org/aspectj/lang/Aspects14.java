...
/**
 * For users working on a level of Java prior to Java5, Aspects14 handles
 * generic aspectOf methods when they are not available in the aspects but added
 * later on through load time weaving. Users on Java5 should use the class
 * Aspects instead.
 * <p/>
 * Aspects14.aspectOf(..) is doing reflective calls to the aspect aspectOf, so
 * for better performance consider using ajc compilation of the aspects and
 * using them as a binary dependancies in your project.
 */
public class Aspects14 {
	...
	/**
	 * Returns the singleton aspect or the percflow / percflowbelow associated with
	 * the current thread
	 *
	 * @param aspectClass
	 * @return
	...
	public static Object aspectOf(Class aspectClass) throws NoAspectBoundException {
		try {
			...
			// FIXME asc Highly temporary change to see what the build makes of it - dont
			// use 1.4 APIs
