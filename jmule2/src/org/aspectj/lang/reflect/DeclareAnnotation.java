...
/**
 * The AspectJ runtime representation of a declare annotation member in an
 * aspect.
 *
 */
public interface DeclareAnnotation {
	...
	/**
	 * The declared annotation. If the declared annotation does not have runtime
	 * retention, this method returns null.
	 */
