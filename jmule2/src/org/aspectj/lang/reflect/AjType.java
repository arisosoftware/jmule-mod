...
/**
 * The runtime representation of a type (Aspect, Class, Interface, Annotation,
 * Enum, or Array) in an AspectJ program.
 */
public interface AjType<T> extends Type, AnnotatedElement {
	...
	/**
	 * The supertype of this type. If this type represents Object or a primitive
	...
	/**
	 * If this type represents a local or anonymous type declared within a method,
	 * return then enclosing Method object.
	 */
	public Method getEnclosingMethod();

	/**
	 * If this type represents a local or anonymous type declared within a
	 * constructor, return then enclosing Method object.
	 */
	...
	/**
	 * If this type is a member of another type, return the AjType representing the
	 * type in which it was declared.
	 */
	public AjType<?> getDeclaringType();

	/**
	 * If this type represents an aspect, returns the associated per-clause. Returns
	 * null for non-aspect types.
	 */
	public PerClause getPerClause();

	// inner types
	/**
	 * Returns an array containing all the public types that are members of this
	 * type
	 */
	...
	/**
	 * Returns the constructor object for the specified public constructor of this
	 * type
	 */
	...
	/**
	 * Return the method object for the specified public method declared in this
	 * type
	 */
	...
	/**
	 * Return the pointcut object representing the specified pointcut declared by
	 * this type
	 */
	...
	/**
	 * Returns all of the advice declared by this type, of an advice kind contained
	 * in the parameter list.
	 */
	public Advice[] getDeclaredAdvice(AdviceKind... ofTypes);

	/**
	 * Returns all of the advice for this type, of an advice kind contained in the
	 * parameter list.
	 */
	public Advice[] getAdvice(AdviceKind... ofTypes);

	/**
	 * Returns the advice with the given name. For an @AspectJ declared advice
	 * member, this is the name of the annotated method. For a code-style advice
	 * declaration, this is the name given in the @AdviceName annotation if present.
	 */
	public Advice getAdvice(String name) throws NoSuchAdviceException;

	/**
	 * Returns the advice declared in this type with the given name. For an @AspectJ
	 * declared advice member, this is the name of the annotated method. For a
	 * code-style advice declaration, this is the name given in the @AdviceName
	...
	/**
	 * Return the inter-type method declared by this type matching the given
	 * specification
	 */
	...
	/**
	 * Return the public inter-type method of this type matching the given
	 * specification
	 */
	...
	/**
	 * Return the inter-type constructor declared by this type matching the given
	 * specification
	 */
	...
	/**
	 * Return the inter-type field declared in this type with the given
	 * specification
	 */
	...
	/**
	 * Returns all of the declare parents members of this type, including declare
	 * parent members inherited from super-types
	 */
	public DeclareParents[] getDeclareParents();

	/**
	 * Return all of the declare soft members of this type, including declare soft
	 * members inherited from super-types
	 */
	...
	/**
	 * Returns the elements of this enum class, or null if this type does not
	...
	/**
	 * True if the given object is assignment-compatible with an object of the type
	 * represented by this AjType
	 */
