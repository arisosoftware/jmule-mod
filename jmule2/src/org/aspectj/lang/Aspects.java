...
/**
 * Handles generic aspectOf method when those are not available in the aspects
 * but added later on thru load time weaving.
 * <p/>
 * Aspects.aspectOf(..) is doing reflective calls to the aspect aspectOf, so for
 * better performance consider using ajc compilation of the aspects and using
 * them as a binary dependancies in your project.
 *
