...
public class Baseline {
	...
	/**
	 * Returns a constant indicating how the baseline varies with the size of the
	 * component.
	 *
	 * @param c
	 *            the JComponent to get the baseline resize behavior for
	 * @return one of BRB_CONSTANT_ASCENT, BRB_CONSTANT_DESCENT, BRB_CENTER_OFFSET
	 *         or BRB_OTHER
	 */
	...
	/**
	 * Returns the baseline for the specified component, or -1 if the baseline can
	 * not be determined. The baseline is measured from the top of the component.
	 * This method returns the baseline based on the preferred size.
	 *
	 * @param component
	...
	/**
	 * Returns the baseline for the specified component, or a value less than 0 if
	 * the baseline can not be determined. The baseline is measured from the top of
	 * the component.
	 *
	 * @param component
	 *            JComponent to calculate baseline for
	...
	/**
	 * Creates an instance of Baseline. You typically don't create a Baseline. The
	 * constructor is provided by look and feels that wish to provide baseline
	 * support.
	 * <p>
	 * A custom look and feel that wants to provide <code>Baseline</code> support
	 * should put the instance in the defaults returned from
	 * <code>getDefaults</code>. If you want to override the baseline suport for a
	 * look and feel place the instance in the defaults returned from
	 * UIManager.getLookAndFeelDefaults(). Tthis will ensure that if the look and
	 * feel changes the appropriate baseline can be used.
	 */
	protected Baseline() {
	}
