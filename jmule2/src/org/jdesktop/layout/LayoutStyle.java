...
public class LayoutStyle {
	...
	/**
	 * Possible argument to getPreferredGap. Used to indicate the two componets are
	 * grouped together.
	 */
	...
	/**
	 * Possible argument to getPreferredGap. Used to indicate the distance to indent
	 * a component is being requested. To visually indicate a set of related
	 * components they will often times be horizontally indented, the
	 * <code>INDENT</code> constant for this. For example, to indent a check box
	 * relative to a label use this constant to <code>getPreferredGap</code>.
	 */
	...
	/**
	 * Sets the LayoutStyle instance to use for this look and feel. You generally
	 * don't need to invoke this, instead use the getter which will return the
	 * LayoutStyle appropriate for the current look and feel.
	 * 
	 * @param layoutStyle
	 ...
	 * around them. Look and feel guidelines generally don't include this space. Use
	 * this method to subtract this space from the specified components.
	 *
	 * @param source
	 *            First component
	 * @param target
	...
	/**
	 * Returns the amount to indent the specified component if it's a JCheckBox or
	 * JRadioButton. If the component is not a JCheckBox or JRadioButton, 0 will be
	 * returned.
	 */
