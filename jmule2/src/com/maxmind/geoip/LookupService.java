...
public class LookupService {
	 ...
	 *             if an error occured creating the lookup service from the database
	 *             file.
	 */
	 ...
	 *            read database from disk GEOIP_MEMORY_CACHE cache the database in
	 *            RAM and read it from RAM
	 * @throws java.io.IOException
	 *             if an error occured creating the lookup service from the database
	 *             file.
	 */
